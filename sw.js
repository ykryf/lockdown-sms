...
const urlsToCache = [
    ...
    basePath,
    basePath + 'index.html',
    basePath + 'images/maskable_icon',
    basePath + 'images/virus_mask.png',
    basePath + 'images/virus_mask_large.png',
    basePath + 'images/virus_mask_small.png',
    ...
    'https://cdnjs.cloudflare.com/ajax/libs/mouse0270-bootstrap-notify/3.1.3/bootstrap-notify.min.js',
